...
function Notifications() {
  ...
  function deleteNotif() {
    axiosInstance
      .delete(`/api/v1/dashboard/notifications/${notifID.id}`)
      .then((res) => {
        console.log(res.data);
    ...
    <>
      <div className="sectiontwo container mt-5 bg-white rounded-4 p-4">
          ...
          <div className="row d-flex justify-content-between gap-2 gap-md-4 py-2 fs-5">
            <div className="d-flex justify-content-start gap-4 col-8">
              <div className="d-flex justify-content-center gap-4 pe-2 align-items-center">
                ...
                <i
                  className="bx bx-circle fw-bolder align-self-center text-center"
                  style={{ color: "#C13F55", width: "5%" }}
                />
              </div>
            ...
            <div className="d-flex justify-content-end gap-4 col">
              ...
              <button
                ...
                data-bs-target="#adminModelDelete"
                onClick={() => storeID(first)}
              >
                <i className="bx bx-x" />
              </button>
          ...
          <>
            {currentItems.map((not, idx) => {
              return (
                <div
                  key={idx}
                  className="d-flex justify-content-between gap-2 gap-md-4 py-2 fs-5"
                >
                  <div className="d-flex justify-content-start gap-2 gap-md-4 py-2 text-secondary">
                    <div className="d-flex justify-content-center gap-5 px-2 align-items-center">
                      ...
                      <i
                        className="bx bx-circle align-self-center text-center"
                        style={{ width: "5%" }}
                      />
                    </div>
        ...
        <div
          ...
          id="adminModelDelete"
          tabIndex={-1}
          aria-labelledby="adminModelDeleteLabel"
          aria-hidden="true"
        >
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              >
                <h1 className="modal-title fs-5" id="adminModelDeleteLabel">
                  Delete Admin
                </h1>
                <button
                  type="button"
        ...
        <div className="d-flex justify-content-between mb-5 mt-4 align-items-center">
          ...
          <button
            type="button"
            className="searchbtn rounded-3 px-3 py-2"
            data-bs-toggle="modal"
          ...
          <div
            ...
            id="adminModel"
            tabIndex={-1}
            aria-labelledby="adminModelLabel"
            aria-hidden="true"
          >
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                ...
                >
                  <h1 className="modal-title fs-5" id="adminModelLabel">
                    Add Notification
                  </h1>
                  <button
                    type="button"
                ...
                <div className="modal-body p-0">
                  <form
                    className="pt-4"
                    onSubmit={handleSubmiti(onSubmit)}
                    encType="multipart/form-data"
                  >
                    <div className="mb-3 px-4">
                      <label htmlFor="exampleInputAname" className="form-label">
                        Title
                      </label>
                      <input
                        type="text"
                        className="form-control"
                        id="exampleInputAname"
                    ...
                    <div className="mb-3 px-4">
                      ...
                      <textarea
                        ...
                        rows={3}
                        name="description"
                        {...registeri("description", {
                          required: "must enter description",
                        })}
                      />
                      <div className="bg-danger text-danger ps-2 mt-2 rounded-2 bg-opacity-10">
                        {errorsi.description?.message}
                      </div>
                    </div>
                    <div className="mb-3 px-4">
                    ...
                    <div className="mb-4 px-4">
                      ...
                      <input
                        ...
                        accept="image/*"
                        name="img"
                        {...registeri("img", { required: "must upload photo" })}
                      />
                      <div className="bg-danger text-danger ps-2 mt-2 rounded-2 bg-opacity-10">
                        {errorsi.img?.message}
                      </div>
